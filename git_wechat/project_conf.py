...
def new_wechat_project():
    project_name = defaultdict()
    project_name = {"普瑞逸-遗传性肿瘤基因检测-男性套餐": "遗传性肿瘤基因检测+男",
                    "普瑞逸-遗传性肿瘤基因检测-女性套餐": "遗传性肿瘤基因检测+女",
    ...
    "舒尼替尼":"舒尼替尼",
    "索拉菲尼":"索拉菲尼",
    "吉非替尼/厄洛替尼/埃克替尼/阿法替尼":"吉非替尼/厄洛替尼/埃克替尼/阿法替尼",
    "克唑替尼":"克唑替尼",
    "奥西替尼(Osimertinib)":"奥西替尼(Osimertinib)",
    "伊马替尼":"伊马替尼",
    "西妥昔单抗/尼妥珠单抗/帕尼单抗":"西妥昔单抗/尼妥珠单抗/帕尼单抗",
    "遗传性乳腺癌/卵巢癌基因检测+奥拉帕尼用药": "奥拉帕尼用药"}
    return project_name
